...
function CryptoPage() {
  const {
    ...
    watch,
    formState: { errors },
  } = useForm({ defaultValues: { countryCode: "CH" } });
  ...
  return (
    <motion.div
      ...
      style={{
        backgroundImage:
          "radial-gradient(circle at 50% 50%, rgba(0,0,0,0.1) 0%, rgba(255,255,255,1) 100%)",
        backgroundSize: "400% 400%",
      }}
    >
      {/* Background Animated Elements - Made highly visible */}
      <motion.div
        className="absolute top-20 left-10 w-64 h-64 border-[30px] border-black opacity-20 rounded-full pointer-events-none z-0"
        variants={floatingShape1}
        animate="animate"
      />
      <motion.div
        className="absolute top-[40%] right-10 w-[300px] h-[300px] border-[20px] border-black opacity-20 pointer-events-none z-0"
        variants={floatingShape2}
        animate="animate"
      />
      <motion.div
        className="absolute bottom-20 left-1/3 w-48 h-48 bg-black opacity-20 pointer-events-none z-0"
        variants={floatingShape1}
        animate="animate"
        ...
        >
          ...
          {[...Array(2)].map((_, i) => (
            <div key={i} className="flex space-x-8 items-center">
              <span>
                BTC: $64,231 <span className="text-green-400">▲ +2.4%</span>
              </span>
              <span>
                ETH: $3,452 <span className="text-red-400">▼ -0.8%</span>
              </span>
              <span>
                SOL: $142 <span className="text-green-400">▲ +5.1%</span>
              </span>
              <span>
                ADA: $0.45 <span className="text-green-400">▲ +1.2%</span>
              </span>
              <span>
                DOGE: $0.12 <span className="text-red-400">▼ -3.4%</span>
              </span>
              <span>
                DOT: $6.78 <span className="text-green-400">▲ +0.5%</span>
              </span>
              <span>
                LINK: $14.20 <span className="text-green-400">▲ +4.2%</span>
              </span>
              <span>
                AVAX: $34.50 <span className="text-red-400">▼ -1.1%</span>
              </span>
            </div>
          ))}
        </motion.div>
          ...
          <div className="md:col-span-2 space-y-12 relative z-10">
            ...
            >
              ...
              <p className="font-serif text-xl leading-relaxed first-letter:text-6xl first-letter:font-bold first-letter:float-left first-letter:mr-3 first-letter:mt-1">
                Dans une ère définie par des avancées technologiques sans précédent, l'émergence des
                monnaies numériques décentralisées a fondamentalement modifié notre compréhension de
                la valeur et de l'échange. La première crypto-monnaie, le Bitcoin, poursuit sa
                marche volatile mais inexorable vers l'acceptation financière grand public, défiant
                les premiers critiques qui l'ont rejetée comme une simple curiosité spéculative.
              </p>
              <p className="font-serif text-xl leading-relaxed">
                L'adoption institutionnelle s'est accélérée rapidement au cours du dernier trimestre
                fiscal, d'importantes entités bancaires créant des bureaux de négociation d'actifs
                numériques dédiés. Ce changement de paradigme suggère une intégration permanente des
                actifs cryptographiques dans l'architecture financière traditionnelle.
              </p>
            </motion.article>
            ...
            >
              ...
              <p className="font-serif text-lg leading-relaxed">
                Alors que le Bitcoin a établi le principe de la rareté décentralisée, Ethereum a
                introduit l'argent programmable. La prolifération des protocoles de finance
                décentralisée (DeFi) fonctionnant sur le réseau Ethereum a créé un système financier
                parallèle, complet avec des instruments de prêt, d'emprunt et de produits dérivés,
                tous s'exécutant de manière autonome sans intermédiation humaine.
              </p>
            </motion.div>
            ...
            >
              ...
              >
                <div className="absolute right-0 -top-3 bg-black text-white text-[10px] px-1 font-mono">
                  ACTUEL
                </div>
              </motion.div>
            </motion.div>
          ...
          <div className="space-y-8 relative z-10">
            ...
            >
              ...
              <p className="font-serif text-sm italic mb-6 text-center">
                Soumettez votre demande concernant la gestion d'actifs numériques. Nos commis vous
                répondront par retour de courrier.
              </p>

              <form
                onSubmit={handleSubmit(onSubmit)}
                className="space-y-4 font-sans text-sm font-bold uppercase"
              >
                <div>
                  ...
                  />
                  {errors.name && (
                    <span className="text-red-600 text-xs mt-1 block">Le nom est requis</span>
                  )}
                </div>
                ...
                <div>
                  ...
                  />
                  {errors.email && (
                    <span className="text-red-600 text-xs mt-1 block">L'e-mail est requis</span>
                  )}
                </div>
                ...
                <div>
                  ...
                  <div style={{ display: "flex", gap: "8px", width: "100%" }}>
                    ...
                    >
                      ...
                      <SelectContent
                        className="bg-[#111] text-white border-white/20 z-[100] max-h-64"
                        side="bottom"
                      >
                  ...
                  {errors.number && (
                    <span className="text-red-600 text-xs mt-1 block">Le numéro est requis</span>
                  )}
                </div>
                ...
                <motion.button
                  whileHover={{
                    ...
                    backgroundColor: isSubmitting ? "transparent" : "#000",
                    color: isSubmitting ? "#000" : "#fff",
                  }}
            ...
            >
              <h4 className="font-sans font-bold uppercase text-center mb-4 tracking-widest text-sm">
                Cotes du Marché
              </h4>
              <ul className="space-y-3 font-mono text-sm">
                <motion.li
                  whileHover={{ scale: 1.05, originX: 0 }}
                  className="flex justify-between cursor-pointer border-b border-black/10 pb-1 hover:text-green-700"
                >
                  <span>BTC/USD</span> <span>64,231.50 ▲</span>
                </motion.li>
                <motion.li
                  whileHover={{ scale: 1.05, originX: 0 }}
                  className="flex justify-between cursor-pointer border-b border-black/10 pb-1 hover:text-red-700"
                >
                  <span>ETH/USD</span> <span>3,452.12 ▼</span>
                </motion.li>
                <motion.li
                  whileHover={{ scale: 1.05, originX: 0 }}
                  className="flex justify-between cursor-pointer border-b border-black/10 pb-1 hover:text-green-700"
                >
                  <span>SOL/USD</span> <span>142.85 ▲</span>
                </motion.li>
                <motion.li
                  whileHover={{ scale: 1.05, originX: 0 }}
                  className="flex justify-between cursor-pointer hover:text-green-700"
                >
                  <span>XRP/USD</span> <span>0.582 ▲</span>
                </motion.li>
              </ul>
            </motion.div>
          </div>
      ...
      >
        ...
        <div className="mt-4 flex justify-center space-x-4">
          <motion.a whileHover={{ y: -2 }} href="/privacy" className="hover:underline">
            Politique de Confidentialité
          </motion.a>
          <motion.a whileHover={{ y: -2 }} href="/terms" className="hover:underline">
